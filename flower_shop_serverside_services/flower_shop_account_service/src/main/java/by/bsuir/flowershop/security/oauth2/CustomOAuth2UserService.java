package by.bsuir.flowershop.security.oauth2;


import by.bsuir.flowershop.dto.model.common.ImageDTO;

import by.bsuir.flowershop.dto.user.UserDTO;
import by.bsuir.flowershop.dto.user.UserRoleDTO;
import by.bsuir.flowershop.entity.user.SupportedAuthProvider;
import by.bsuir.flowershop.entity.user.UserRoles;
import by.bsuir.flowershop.security.core.UserPrincipal;
import by.bsuir.flowershop.security.exception.OAuth2AuthenticationProcessingException;
import by.bsuir.flowershop.security.oauth2.user.OAuth2UserInfo;
import by.bsuir.flowershop.security.oauth2.user.OAuth2UserInfoFactory;
